...
CREATE TABLE IF NOT EXISTS Bestellung (ID int NOT NULL AUTO_INCREMENT,ZEITPUNKT_BESTELLT DATE, ZEITPUNKT_VORBEREITET DATE, ZEITPUNKT_ANGEKOMMEN DATE, ZEITPUNKT_LEERGETRUNKEN DATE,INITIALGEWICHT DECIMAL,PRIMARY KEY (ID), PLATZ_ID int);
