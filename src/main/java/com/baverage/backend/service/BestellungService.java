...
public class BestellungService implements IBestellungService {
    ...
    public Bestellungen createBestellung(int platz_id, int getraenk_id, int status_id, int kunde_id) throws NoSuchElementException {
        LOGGER.info("Create a new bestellung with p: {}, g: {}, s: {}, k: {}", platz_id, getraenk_id, status_id, kunde_id);
        ...
        bestellung.setKunde(kundeRepo.findById(kunde_id).get());
